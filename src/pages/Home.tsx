      ...
      >
        ...
        <div className="mt-4 md:mt-0">
          <Link to="/daily-record/new">
            <button className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-2.5 rounded-full font-medium flex items-center hover:from-blue-600 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/todo-list">
              <span className="text-blue-500 text-sm flex items-center hover:underline">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <Link to="/todo-list/new">
                <button className="w-full py-2.5 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <Link to={item.path} key={index}>
                  <div className="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors cursor-pointer">
                    <div className="p-2 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 mb-2">
                      {item.icon}
                    </div>
